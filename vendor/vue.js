...
;(function (global, factory) {
  ...
  function renderStatic(index, isInFor, isOnce) {
    ...
    let isOldVersion = arguments.length < 3
  ...
  function createFunctionalComponent(Ctor, propsData, data, contextVm, children) {
    ...
    let renderContext = new FunctionalRenderContext(data, props, children, contextVm, Ctor)
  ...
  function model(el, dir, _warn) {
...

    {
      ...
      if (
        ...
        let vBindValue = attrsMap['v-bind:value'] ? 'v-bind:value' : ':value'
        warn$1(
          vBindValue +
