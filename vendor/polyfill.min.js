  ...
  function s(o, u) {
    if (!n[o]) {
      if (!t[o]) {
        ...
        if (!u && c) return c(o, !0)
        if (i) return i(o, !0)
        let a = new Error("Cannot find module '" + o + "'")
        ...
        n.exports =
          ...
          function bind(t) {
            let n = e(this),
              ...
              c = function () {
                let e = r.concat(u.call(arguments))
      ...
      function (t, n, r) {
        ...
        n.exports =
          ...
          function create(t, n) {
            let r
            return (
              null !== t ? ((c.prototype = e(t)), (r = new c()), (c.prototype = null), (r[u] = t)) : (r = a()),
              void 0 === n ? r : i(r, n)
            )
          }
      },
        ...
        let e = t(33),
          ...
          c = function (t, n, r, e) {
            let i = String(o(t)),
              c = '<' + n
            return (
              '' !== r && (c += ' ' + r + '="' + String(e).replace(u, '&quot;') + '"'), c + '>' + i + '</' + n + '>'
            )
          }
        n.exports = function (t, n) {
          let r = {}
    ...
    122: [
      function (t, n, r) {
        ...
        function set(t, n, r, e, i, o) {
          ...
          for (let a = t[k]._b, f = c + t[j], s = e(+i), l = 0; l < n; l++) a[f + l] = s[o ? l : n - l - 1]
        }
        var e = t(40),
          i = t(29),
          o = t(60),
          ...
          (x = function ArrayBuffer(t) {
            ...
            a(S[m], {
              ...
              getInt16: function getInt16(t) {
                let n = get(this, 2, t, arguments[1])
    ...
    126: [
      function (t, n, r) {
        let e = t(40),
          ...
          c = t(72).f
        n.exports = function (t) {
          let n = i.Symbol || (i.Symbol = o ? {} : e.Symbol || {})
    ...
    188: [
      function (t, n, r) {
        ...
        let e = t(33),
          ...
          l = function (t, n) {
            for (let r = -1, e = n; ++r < 6; ) (e += t * f[r]), (f[r] = e % 1e7), (e = a(e / 1e7))
          },
          h = function (t) {
            for (let n = 6, r = 0; --n >= 0; ) (r += f[n]), (f[n] = a(r / t)), (r = (r % t) * 1e7)
          },
          v = function () {
            for (var t = 6, n = ''; --t >= 0; )
              if ('' !== n || 0 === t || 0 !== f[t]) {
          ...
          'Number',
          {
            toFixed: function toFixed(t) {
              ...
              return (
                f > 0
                  ? ((c = g.length),
                    (g = y + (c <= f ? '0.' + u.call('0', f - c) + g : g.slice(0, c - f) + '.' + g.slice(c - f))))
                  : (g = y + g),
                g
              )
            }
        ...
        e(
          ...
          'Number',
          {
            toPrecision: function toPrecision(t) {
              let n = o(this, 'Number#toPrecision: incorrect invocation!')
                ...
                for (var e = t._v, i = 1 == t._s, o = 0; r.length > o; )
                  !(function (n) {
                    ...
                    try {
                      u
                        ? (i || (2 == t._h && T(t), (t._h = 1)),
                          !0 === u ? (r = e) : (f && f.enter(), (r = u(e)), f && f.exit()),
                          r === n.promise ? a(w('Promise-chain cycle')) : (o = A(r)) ? o.call(r, c, a) : c(r))
                        : a(e)
                    } catch (t) {
                      a(t)
                    }
    ...
    223: [
      function (t, n, r) {
        function set(t, n, r) {
          ...
          return u(v, 'value')
            ? !(!1 === v.writable || !s(h)) && ((c = i.f(h, n) || a(0)), (c.value = r), e.f(h, n, c), !0)
        ...
        if (
          ...
          f = function RegExp(t, n) {
            ...
            return !r && e && t.constructor === f && o
              ? t
              : i(
                  p ? new s(e && !o ? t.source : t, n) : s((e = t instanceof f) ? t.source : t, e && o ? a.call(t) : n),
                  r ? this : l,
                  f
                )
          }
          for (let d = u(s), y = 0; d.length > y; )
            !(function (t) {
              t in f ||
                o(f, t, {
                  configurable: !0,
          ...
          if (
            ...
            e = function (t, n) {
              ...
              let e,
                ...
                v = [],
                p =
                  (t.ignoreCase ? 'i' : '') + (t.multiline ? 'm' : '') + (t.unicode ? 'u' : '') + (t.sticky ? 'y' : ''),
                d = 0,
      ...
      function (t, n, r) {
        ...
        let e = t(40),
          ...
          Y = function defineProperty(t, n, r) {
            return (
              ...
              i(D, n)
                ? (r.enumerable
                    ? (i(t, T) && t[T][n] && (t[T][n] = !1), (r = _(r, { enumerable: w(0, !1) })))
        ...
        U ||
          ((k = function Symbol() {
            ...
            let t = h(arguments.length > 0 ? arguments[0] : void 0),
              n = function (r) {
        ...
        for (
          ...
          v(tt[nt++])
        for (let rt = M(v.store), et = 0; rt.length > et; ) d(rt[et++])
        u(u.S + u.F * !U, 'Symbol', {
          for: function (t) {
    ...
    296: [
      function (t, n, r) {
        ...
        l(S.prototype, {
          ...
          l(S, {
            from: function from(t) {
              let n = 'function' == typeof this ? this : S,
                r = d(f(t)[c])
              if (r) {
                let e = f(r.call(t))
        ...
        ;(function (t) {
          !(function (t) {
            ...
            function wrap(t, n, r, e) {
              let i = n && n.prototype instanceof Generator ? n : Generator,
            ...
            function maybeInvokeDelegate(t, n) {
              let e = t.iterator[n.method]
              if (e === r) {
                if (((n.delegate = null), 'throw' === n.method)) {
                  if (
                    t.iterator.return &&
                    ((n.method = 'return'), (n.arg = r), maybeInvokeDelegate(t, n), 'throw' === n.method)
                  )
                    return d
              ...
              let i = tryCatch(e, t.iterator, n.arg)
            ...
            let b = (GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(y))
            ;(GeneratorFunction.prototype = b.constructor = GeneratorFunctionPrototype),
              ...
              (s.isGeneratorFunction = function (t) {
                let n = 'function' == typeof t && t.constructor
              ...
              (s.mark = function (t) {
                return (
                  Object.setPrototypeOf
                    ...
                    : ((t.__proto__ = GeneratorFunctionPrototype), a in t || (t[a] = 'GeneratorFunction')),
              ...
              (s.async = function (t, n, r, e) {
                let i = new AsyncIterator(wrap(t, n, r, e))
              ...
              (Context.prototype = {
                ...
                reset: function (t) {
                  if (
                    ...
                    for (let n in this) 't' === n.charAt(0) && i.call(this, n) && !isNaN(+n.slice(1)) && (this[n] = r)
                },
                stop: function () {
                  this.done = !0
